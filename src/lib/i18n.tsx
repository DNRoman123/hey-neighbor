...
const es: Dict = {
  ...
  "Given to my neighbor": "Entregado a mi vecino",
  Given: "Entregado",
  "Marked as given to your neighbor.": "Marcado como entregado a tu vecino.",
  "Could not mark that item as given.": "No se pudo marcar ese artículo como entregado.",
  Neighbor: "Vecino",
  "Currently sharing": "Compartiendo ahora",
  "Nothing shared right now.": "Nada compartido en este momento.",
  "This neighbor is no longer available.": "Este vecino ya no está disponible.",
