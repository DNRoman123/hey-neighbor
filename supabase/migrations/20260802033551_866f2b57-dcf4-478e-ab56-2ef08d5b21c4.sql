...
COMMENT ON FUNCTION public.owner_accept_claim(uuid, text) IS 'Owner agrees to give the item. Counts toward the 2 free claims/month; 3rd+ costs 1 unit of the requested currency.';